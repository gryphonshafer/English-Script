...
is(
    ...
    [
        ...
        [
            'if ( typeof( 42.special.prime ) == "undefined" ) var 42.special.prime = {};',
            '42.special.prime = 3;'
        ],
    ],
    [
    ...
    [
        ...
        'If prime is 3 and primes contains 7 and something is true, then set answer to 42.',
        [
            'if ( typeof( answer ) == "undefined" ) var answer = {};',
            'if ( typeof( prime ) == "undefined" ) var prime = {};',
            'if ( typeof( primes.contains.7 ) == "undefined" ) var primes.contains.7 = {};',
            'if ( typeof( something ) == "undefined" ) var something = {};',
            'if ( typeof( true ) == "undefined" ) var true = {};',
            'if ( 9 ) {',
            'answer = 42;',
